...
/** String for no input. */
const char_t rom_string_input_none[] = "NONE";

/** String for up input. */
const char_t rom_string_input_up[] = "UP";

/** String for right input. */
const char_t rom_string_input_right[] = "RIGHT";

/** String for down input. */
const char_t rom_string_input_down[] = "DOWN";

/** String for left input. */
const char_t rom_string_input_left[] = "LEFT";

/** String for B input. */
const char_t rom_string_input_b[] = "B";

/** String for A input. */
const char_t rom_string_input_a[] = "A";

/** String for select input. */
const char_t rom_string_input_select[] = "SELECT";

/** String for start input. */
const char_t rom_string_input_start[] = "START";
